...
planet = pygame.image.load("planet.jpg").convert_alpha()
ship = pygame.image.load("spaceship.jpg").convert_alpha()
width, height = planet.get_size()
planet = pygame.transform.smoothscale(planet, (width//3, height//3))
width, height = ship.get_size()
ship = pygame.transform.smoothscale(ship, (width//3, height//3))
